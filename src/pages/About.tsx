      ...
      <section>
        ...
        <div class="flex flex-wrap my-16 w-full justify-center gap-y-4">
          <Card
            imgSrc={diagramLogo}
            imgAlt="growth-icon"
            title={t('about.whatWeDo.cards.growth.title')}
            text={t('about.whatWeDo.cards.growth.desc')}
            className="w-2xl h-[16rem]"
          ></Card>
          <Card
            imgSrc={focusLogo}
            imgAlt="focus-icon"
            title={t('about.whatWeDo.cards.focus.title')}
            text={t('about.whatWeDo.cards.focus.desc')}
            className="w-2xl h-[16rem]"
          ></Card>
        </div>
      </section>
