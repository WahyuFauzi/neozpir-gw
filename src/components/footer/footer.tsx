    ...
    <footer class="bg-white border-t border-gray-200 py-12 px-4">
      <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-gray-700">
        <div>
          ...
          <p class="text-sm text-gray-600">{t('footer.tagline')}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li class="flex items-center gap-2">
              ...
              <a href="mailto:support@neozpir.com" class="hover:underline">
            ...
            <li class="flex items-center gap-2">
              ...
              <a
                href={`https://wa.me/6289670377077?text=${t('whatsapp.footerMessage')}`}
      ...
      <div class="mt-10 border-t border-gray-200 pt-6 text-center text-sm text-gray-500">
        © 2025 PT NEOZPIR MAJU BERSAMA. All rights reserved. Powered by Cloudflare Worker
      </div>
    </footer>
  );
}
